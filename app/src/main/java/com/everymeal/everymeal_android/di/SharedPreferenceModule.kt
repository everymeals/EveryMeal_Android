...
object SharedPreferenceModule {
    private const val DEBUG_APP_PREFERNCES_NAME = "everymeal_debug"
    private const val APP_PREFERENCES_NAME = "everymeal"
    ...
    interface Binder {
        @Singleton
        @Binds
        fun bindNetworkPreferences(networkPreference: DefaultNetworkPreference): NetworkPreference
    }
}
